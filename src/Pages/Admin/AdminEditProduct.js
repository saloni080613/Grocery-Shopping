...
stockQuantity: parseInt(product.stock_quantity, 10) || 0,
...
<label htmlFor="image" style={labelStyle}>Image URL</label>
          <input type="text" id="image" name="image_url" value={product.image_url} onChange={handleChange} style={inputStyle} />
</div>

<div style={inputGroupStyle}>
<label htmlFor="stock" style={labelStyle}>Stock Quantity</label>
          <input type="number" id="stock" name="stock_quantity" value={product.stock_quantity} onChange={handleChange} style={inputStyle} min="0" required />
</div>
